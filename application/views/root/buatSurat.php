			...
			<div class="card">
				...
				<div class="card-body">
					<form action="<?= base_url("root/ubahDataSurat"); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label for="email2">Email Mahasiswa Anggota</label>
							<input type="text" name="email2" class="form-control" id="email2" value="<?= $mahasiswa['email2']; ?>">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="email3">Email Mahasiswa Anggota</label>
							<input type="text" name="email3" class="form-control" id="email3" value="<?= $mahasiswa['email3']; ?>">
						</div>
